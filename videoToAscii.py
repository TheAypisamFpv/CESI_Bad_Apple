...
VIDEO_PATH = input("Enter the path of the video you want to convert:\n> ")
...
INVERTED = False if input("Invert the video (default white = char, black = no char) (default False) y/N :\n> ") == "" else True
...
print(f"ASCII video settings : {width//RESIZE_FACTOR}x{height//(RESIZE_FACTOR*2)}@{fps}fps_{frame_nbr}_{STORAGE_METHOD}")